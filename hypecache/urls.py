...
urlpatterns = [
    ...
    path(
        "product/new/",
        staff_member_required(ProductCreateView.as_view(), login_url="login"),
        name="product-create",
    ),
    ...
    path(
        "shipping/<int:pk>/update/",
        ShippingUpdateView.as_view(),
    ...
    path(
        "profile/<int:pk>/update/", CustomerUpdateView.as_view(), name="profile-update"
    ),
